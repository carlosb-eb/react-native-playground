...
export const Switch = createStyle({
  props: {
    ...
    //@ts-ignore
    trackColor: { false: "$backgroundLight300", true: "$primary400" },
  ...
  ":disabled": {
    ...
    //@ts-ignore
    trackColor: { false: "$backgroundLight300", true: "$light400" },
    // for ios specifically in unchecked state
    ios_backgroundColor: "$backgroundLight300",
    ":hover": {
      props: {
  ...
  ":hover": {
    props: {
      ...
      trackColor: { false: "$backgroundLight400", true: "$primary400" },
  ...
  _dark: {
    props: {
      //@ts-ignore
      trackColor: { false: "$backgroundDark700", true: "$primary400" },
